            ...
            {//<!-- sidebar -->
                  ...
                  {//<!-- price slider -->
									...
									<form method="get" action="/" className="form-inline">
										...
										<div className="slider-range-price"></div>

										<div className="form-group">
											<label className="grey" htmlFor="slider_price_min">From:</label>
											<input type="text" className="slider_price_min form-control text-center" id="slider_price_min" readOnly/>
										</div>

										<div className="form-group">
											<label className="grey" htmlFor="slider_price_max"> to:</label>
											<input type="text" className="slider_price_max form-control text-center" id="slider_price_max" readOnly/>
										</div>
